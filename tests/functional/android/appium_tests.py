...
class AppiumRealTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_open_notifications(self):
        ...
        sleep(1)
        self.assertRaises(NoSuchElementException, self.driver.find_element_by_android_uiautomator, 'new UiSelector().text(":-|")')
...
if __name__ == "__main__":
    suite = unittest.TestLoader().loadTestsFromTestCase(AppiumRealTests)
